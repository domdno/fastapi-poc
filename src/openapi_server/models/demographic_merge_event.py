...
from openapi_server.models.demographic_merge_event_all_of_data import DemographicMergeEventAllOfData
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class DemographicMergeEvent(BaseModel):
    """
    Notifies two or more individual demographic records have been combined and only one active (survivor) record should continue to be used. 
    """ # noqa: E501
    ...
    data: DemographicMergeEventAllOfData
    __properties: ClassVar[List[str]] = ["version", "createdTimestamp", "requestId", "eventType", "data"]

    @field_validator('event_type')
    def event_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('patient.demographics.merged',):
            raise ValueError("must be one of enum values ('patient.demographics.merged')")
        return value
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of DemographicMergeEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of DemographicMergeEvent from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": DemographicMergeEventAllOfData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
