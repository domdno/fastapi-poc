...
class DemographicMergeEventAllOfData(BaseModel):
    """
    DemographicMergeEventAllOfData
    """ # noqa: E501
    ...
    inoperative_individual_ids: Annotated[List[Annotated[str, Field(min_length=14, strict=True, max_length=14)]], Field(min_length=1, max_length=50)] = Field(description="List of individual IDs to be inoperative as a result of the merge (losser records). These records represented the same patient (or legal caregiver/guardian) but no accurately. ", alias="inoperativeIndividualIds")
    __properties: ClassVar[List[str]] = ["changeDate", "dataProviderId", "crossReferences", "individualType", "activeIndividual", "inoperativeIndividualIds"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of DemographicMergeEventAllOfData from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of DemographicMergeEventAllOfData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "inoperativeIndividualIds": obj.get("inoperativeIndividualIds")
        })
        return _obj
