...
class PatchPatientConsentsBrandRequest(BaseModel):
    """
    PatchPatientConsentsBrandRequest
    """ # noqa: E501
    ...
    consents_and_preferences: Annotated[List[Consent], Field(min_length=1)] = Field(description="List of opt-ins and opt-outs the patient has provided to BI and partners", alias="consentsAndPreferences")
    __properties: ClassVar[List[str]] = ["dataProviderId", "dataProviderPatientId", "dataProviderTransactionId", "consentsAndPreferences"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PatchPatientConsentsBrandRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PatchPatientConsentsBrandRequest from a dict"""
        if obj is None:
            return None
