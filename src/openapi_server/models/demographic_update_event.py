...
from openapi_server.models.demographic_update_event_all_of_data import DemographicUpdateEventAllOfData
try:
...
class DemographicUpdateEvent(BaseModel):
    """
    Notifies an individual's latest demographic data.
    """ # noqa: E501
    ...
    data: Optional[DemographicUpdateEventAllOfData] = None
    __properties: ClassVar[List[str]] = ["version", "createdTimestamp", "requestId", "eventType", "data"]

    @field_validator('event_type')
    def event_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('patient.demographics.updated',):
            raise ValueError("must be one of enum values ('patient.demographics.updated')")
        return value
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of DemographicUpdateEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of DemographicUpdateEvent from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": DemographicUpdateEventAllOfData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
