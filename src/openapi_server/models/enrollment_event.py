...
class EnrollmentEvent(BaseModel):
    """
    Notifies a patient has enrolled to a PSP or Copay program or they have updated their enrollment details.
    """ # noqa: E501
    ...
    def event_type_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^[a-zA-Z]+\.enrollment\.(created|updated)$", value):
            raise ValueError(r"must validate the regular expression /^[a-zA-Z]+\.enrollment\.(created|updated)$/")
        return value
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of EnrollmentEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of EnrollmentEvent from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": FlexEnrollment.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
