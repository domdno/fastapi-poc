...
from openapi_server.models.pace_update_event_all_of_data import PaceUpdateEventAllOfData
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class PaceUpdateEvent(BaseModel):
    """
    Notifies a patient completed an interaction with a CLinical Educator and the outcome.
    """ # noqa: E501
    ...
    event_type: Annotated[str, Field(strict=True)] = Field(description="Message Topic. Indicates the type of data is being sent with the event.", alias="eventType")
    data: PaceUpdateEventAllOfData
    ...
    def event_type_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^[a-zA-Z]+\.pace\.updated$", value):
            raise ValueError(r"must validate the regular expression /^[a-zA-Z]+\.pace\.updated$/")
        return value
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PaceUpdateEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PaceUpdateEvent from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": PaceUpdateEventAllOfData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
