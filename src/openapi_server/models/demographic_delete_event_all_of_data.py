...
class DemographicDeleteEventAllOfData(BaseModel):
    """
    DemographicDeleteEventAllOfData
    """ # noqa: E501
    ...
    individual_id: Annotated[str, Field(min_length=14, strict=True, max_length=15)] = Field(description="BI's patient or legal caregiver/guardian unique identifier (MDM ID).    This is teh identifier that it has been associated with the delete request.", alias="individualId")
    __properties: ClassVar[List[str]] = ["changeDate", "dataProviderId", "crossReferences", "individualType", "individualId"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of DemographicDeleteEventAllOfData from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of DemographicDeleteEventAllOfData from a dict"""
        if obj is None:
            return None
