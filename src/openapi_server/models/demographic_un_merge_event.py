...
from openapi_server.models.demographic_un_merge_event_all_of_data import DemographicUnMergeEventAllOfData
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class DemographicUnMergeEvent(BaseModel):
    """
    Notifies an individual demographic record previously merged representes different patients.
    """ # noqa: E501
    ...
    data: DemographicUnMergeEventAllOfData
    __properties: ClassVar[List[str]] = ["version", "createdTimestamp", "requestId", "eventType", "data"]

    @field_validator('event_type')
    def event_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('patient.demographics.unMerged',):
            raise ValueError("must be one of enum values ('patient.demographics.unMerged')")
        return value
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of DemographicUnMergeEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of DemographicUnMergeEvent from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": DemographicUnMergeEventAllOfData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
