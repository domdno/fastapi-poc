...
class Individual(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["addressLine1", "addressLine2", "city", "stateOrProvinceCode", "countryCode", "postalCode", "enrichedIndicator", "id", "firstName", "lastName", "birthDate", "gender", "preferredLanguageCode", "namePrefixCode", "nameSuffixCode", "middleName", "communications"]
