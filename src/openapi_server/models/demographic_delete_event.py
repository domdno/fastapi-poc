...
from openapi_server.models.demographic_delete_event_all_of_data import DemographicDeleteEventAllOfData
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class DemographicDeleteEvent(BaseModel):
    """
    Notifies a patient has requested their data to be forgotten. 
    """ # noqa: E501
    ...
    data: Optional[DemographicDeleteEventAllOfData] = None
    __properties: ClassVar[List[str]] = ["version", "createdTimestamp", "requestId", "eventType", "data"]

    @field_validator('event_type')
    def event_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('patient.demographics.deleted',):
            raise ValueError("must be one of enum values ('patient.demographics.deleted')")
        return value
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of DemographicDeleteEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of DemographicDeleteEvent from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": DemographicDeleteEventAllOfData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
