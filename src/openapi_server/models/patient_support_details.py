...
class PatientSupportDetails(BaseModel):
    """
    Brand specific services enrollment and patient's health related data
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["clinicalDetails", "insuranceTypes", "insurancePlans", "serviceSubscriptions"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PatientSupportDetails from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PatientSupportDetails from a dict"""
        if obj is None:
            return None
