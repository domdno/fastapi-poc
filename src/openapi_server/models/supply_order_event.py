...
from openapi_server.models.supply_order import SupplyOrder
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class SupplyOrderEvent(BaseModel):
    """
    Notifies that a supply is required to be delivered to the patient.
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SupplyOrderEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SupplyOrderEvent from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": SupplyOrder.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
