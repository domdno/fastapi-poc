...
class DemographicUpdateEventAllOfData(BaseModel):
    """
    DemographicUpdateEventAllOfData
    """ # noqa: E501
    change_date: date = Field(description="Effective date of change in the Master Identity system. ", alias="changeDate")
    data_provider_id: Annotated[str, Field(min_length=1, strict=True, max_length=50)] = Field(description="BI assigned unique identifier. Determines which system received the initial demographic update from the patient.", alias="dataProviderId")
    ...
    __properties: ClassVar[List[str]] = ["changeDate", "dataProviderId", "crossReferences", "individualType", "activeIndividual"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of DemographicUpdateEventAllOfData from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of DemographicUpdateEventAllOfData from a dict"""
        if obj is None:
            return None
