...
class Address(BaseModel):
    """
    Individual (i.e Patient or HCP) contact location for mailing purposes
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["addressLine1", "addressLine2", "city", "stateOrProvinceCode", "countryCode", "postalCode", "enrichedIndicator"]
