...
class Email(BaseModel):
    ...
    address: Annotated[str, Field(min_length=1, strict=True, max_length=100)] = Field(description="Phone number. Refer to the brand documentation for details.")
    __properties: ClassVar[List[str]] = ["type", "isPrimary", "status", "address"]
