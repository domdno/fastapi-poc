...
class Patient(BaseModel):
    """
    Demographic data able to identify a person enrolling to receive service offerings.   When the patient is designated as a \"minor\" in their country of residency their legal Caregiver or Guardian information is required.
    """ # noqa: E501
